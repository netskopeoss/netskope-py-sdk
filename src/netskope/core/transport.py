...
# SCIM success bodies use the SCIM media type (scim/scim-apis.yaml:1029, :1260,
# :1711), but every documented SCIM error body is plain application/json and
# only that (GET /Users 400/403/501 at :1195, :1218, :1228; GET /Groups at
# :320, :343, :353). Accepting both keeps a conformant server from answering
# 406 instead of the error body the SDK reads its message from; Content-Type
# stays the bare SCIM type, which is what the request bodies are.
_SCIM_ACCEPT = f"{_SCIM_MEDIA_TYPE}, application/json"
