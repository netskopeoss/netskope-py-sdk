...
from netskope.resources.alerts.resource import AlertsResource, AsyncAlertsResource
...
from netskope.resources.events.resource import AsyncEventsResource, EventsResource
from netskope.resources.incidents.resource import AsyncIncidentsResource, IncidentsResource
...
from netskope.resources.private_apps.resource import AsyncPrivateAppsResource, PrivateAppsResource
from netskope.resources.publishers.resource import AsyncPublishersResource, PublishersResource
...
from netskope.resources.scim.resource import AsyncScimResource, ScimResource
...
class AsyncNetskopeClient:
    ...
    @property
    def version(self) -> str:
        """The SDK version this client reports as its user agent."""
        return __version__

    @property
    def tenant(self) -> str:
        """The resolved tenant hostname this client talks to."""
        return self._config.tenant

    @property
    def base_url(self) -> str:
        """The tenant base URL every request is joined against."""
        return self._config.base_url
