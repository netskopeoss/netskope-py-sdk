...
from netskope.resources.enrollment.decoder import (
    _TOKENSET_LIST_RETRY_SAFE,
    AsyncEnrollmentResponses,
    EnrollmentResponses,
)
...
class EnrollmentResource(SyncResource):
    ...
    def list_token_sets(
        ...
        *,
        ...
        nothing is sent on the query string. The operation is declared
        ``access: rw`` (:81), so the request is never retried.
        ...
        response = self._transport.request(
            "GET", _TOKENSET_PATH, retry_safe=_TOKENSET_LIST_RETRY_SAFE
        )
