...
from netskope.resources.local_brokers.resource import (
    AsyncLocalBrokersResource,
    LocalBrokersResource,
)
from netskope.resources.npa_policy.resource import AsyncNpaPolicyResource, NpaPolicyResource
from netskope.resources.shared.npa import parse_item, parse_page
from netskope.resources.upgrade_profiles.resource import (
