...
from netskope.resources.rbac import (
    _ADMINS_PATH,
    _ROLES_PATH,
    _build_admins_page_params,
    _build_role_request,
    _build_roles_page_params,
    _parse_admins_page,
    _parse_role_detail,
    _parse_role_receipt,
    _parse_roles_page,
...
class RbacRolesResponses(SyncResource):
    ...
    def list_page(
        ...
        *,
        ...
        params = _build_roles_page_params(role_type, scope, search, limit, offset)
    ...
    def get_detail(self, role_id: int) -> ApiResponse[RbacRoleDetail]:
    ...
    def update_receipt(self, role_id: int, request: RolePatch) -> ApiResponse[RoleMutationReceipt]:
        rid = validate_id(role_id, "role_id")
...
class AsyncRbacRolesResponses(AsyncResource):
    ...
    async def get_detail(self, role_id: int) -> ApiResponse[RbacRoleDetail]:
        rid = validate_id(role_id, "role_id")
    ...
    async def update_receipt(
        self, role_id: int, request: RolePatch
